...
The full legel code of the licenses can be found at `COPYING.txt` (GPLv3) and `COPYING.LESSER.txt` (LGPLv3, the additional terms).

    Fai chun: The traditional decoration in China
